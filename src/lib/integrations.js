...
export const sendPasswordResetEmail = async (email, name, tempPassword) => {
  ...
  console.log(`➡️ [EmailJS Password Reset]: Sending temporary password to`, email);

  const templateParams = {
    to_email: email,
    customer_name: name || "Customer",
    message: `Your temporary password is: ${tempPassword}\n\nPlease log in and change your password from your profile settings.`,
    order_number: "Password Reset",
    order_status: "Temporary Password",
    customer_phone: "",
    customer_email: email,
    shipping_address: "",
    order_total: "",
    items_list: `Temporary password: ${tempPassword}`
  };
