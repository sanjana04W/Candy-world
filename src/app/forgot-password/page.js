  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-candy-pink/5 via-white to-candy-purple/5">
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 max-w-md w-full relative z-10">
        ...
        {successMsg && (
          <div className="mb-6 bg-emerald-50 text-emerald-600 px-4 py-3 rounded-2xl border border-emerald-100 flex items-start gap-3 animate-bounce shadow-sm shadow-emerald-500/10">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-50/50 border border-gray-200 rounded-2xl px-4 py-3 pl-11 text-sm focus:outline-none focus:ring-2 focus:ring-candy-purple/30 focus:border-candy-purple focus:bg-white transition-all text-gray-800 disabled:opacity-50"
              />
        ...
        <div className="text-center mt-6 pt-6 border-t border-gray-50">
          <Link
            href="/login"
            className="inline-flex items-center gap-1.5 font-bold text-xs text-gray-400 hover:text-candy-purple transition-colors"
          >
